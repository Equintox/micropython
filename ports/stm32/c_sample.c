...
//add two numbers
STATIC mp_obj_t c_sample_func_add(mp_obj_t n1, mp_obj_t n2) {
	uint32_t result = add(mp_obj_get_int(n1), mp_obj_get_int(n2));
	printf("Result: %lu\n", result);
	return mp_obj_new_int(result);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_2(c_sample_func_add_obj, c_sample_func_add);
...
STATIC const mp_map_elem_t c_sample_globals_table[] = {
    ...
    { MP_OBJ_NEW_QSTR(MP_QSTR_func_0), (mp_obj_t)&c_sample_func_0_obj },
    { MP_OBJ_NEW_QSTR(MP_QSTR_func_1), (mp_obj_t)&c_sample_func_1_obj },
    { MP_OBJ_NEW_QSTR(MP_QSTR_func_2), (mp_obj_t)&c_sample_func_2_obj },
    { MP_OBJ_NEW_QSTR(MP_QSTR_func_3), (mp_obj_t)&c_sample_func_3_obj },
    { MP_OBJ_NEW_QSTR(MP_QSTR_func_var), (mp_obj_t)&c_sample_func_var_obj },
